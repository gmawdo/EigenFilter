...
point_id_130_returnnum = las_range(dimension=f090_000.return_num[point_id_dropnoise],
                                   start=1, end=2,
                                   reverse=False,
                                   point_id_mask=point_id_dropnoise)

point_id_130_num_returns = las_range(dimension=f090_000.num_returns[point_id_130_returnnum],
                                     start=1, end=2,
                                     reverse=False,
                                     point_id_mask=point_id_130_returnnum)

point_id_130_class = las_range(dimension=f090_000.classification[point_id_130_num_returns],
                               start=4, end=5,
                               reverse=False,
                               point_id_mask=point_id_130_num_returns)

point_id_130_intensity = las_range(dimension=f090_000.intensity[point_id_130_class],
                                   start=600,
                                   reverse=True,
