...
output_file = 'T000_job091_01_50.las'
...
print(len(point_mask_xy_lin))
f091_050 = rh_io.las_output(output_file, f091_001, mask=point_mask_xy_lin)
# point_mask_lin_reg = las_range(dimension=f091_050.lin_reg,
#                                end=1000,
#                                reverse=False,
#                                point_id_mask=point_mask_xy_lin)
# print(len(point_mask_lin_reg))
